 ...
 **현재 부득이한 이유로 인해 웹 백엔드 api 구현 프로젝트인 resell-platform이 삭제되었습니다. 복구가 정상적으로 되기 전에 기업 서류 평가가 이뤄질 수 있어 resell-platform-temporary 프로젝트 임시 복구한 상황입니다. 임시 repo의 WIKI는 온전한 상태가 아니지만, 빠르게 복구하여 기업 서류 제출에 문제 없도록 하겠습니다.**
